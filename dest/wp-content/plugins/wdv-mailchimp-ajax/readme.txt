...
== Screenshots ==
1. Add widget "WDV: Subscribe mailchimp" using "Appearance > Widgets". (You can go to WP Customizer find section "Widgets" there, choose sidebar and you can place widget "WDV: Subscribe mailchimp" here.)
2. Add widget "WDV: Subscribe mailchimp" using WP Customizer. (You can go to WP Customizer find section "Widgets" there, choose sidebar and you can place widget "WDV: Subscribe mailchimp" here.)
3. Widget "WDV: Subscribe mailchimp". (Here you can see admin part of widget "WDV: Subscribe mailchimp".)
...
5. The appearance of the widget by default. (By default widget "WDV: Subscribe mailchimp"  has the same design as the rest of your theme widgets.)
6. Change the appearance of the widget. (You can change the appearance of the widget "WDV: Subscribe mailchimp" - change text color or background color.)
7. Changing the title color. (For example you can change the title color for widget "WDV: Subscribe mailchimp".)
8. How does it work for your website visitors? (When your website visitors will click the subscribe button - they'll get the answer you're subscribed to our newsletter.)
