...
class WDV_MailChimp_Ajax extends WP_Widget {
    ...
    */
	...
	$( document ).ready( function() {
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php _e( 'Title:', 'wdv_mailchimp_ajax_widget' ); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php _e( 'Description:', 'wdv_mailchimp_ajax_widget' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'buttontext' )); ?>"><?php _e( 'Text on button:', 'wdv_mailchimp_ajax_widget' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'apiKey' )); ?>"><?php _e( 'API Key (from MailChimp):', 'wdv_mailchimp_ajax_widget' ); ?></label>
        ...
        <p>                                                                  
        <label for="<?php echo esc_attr($this->get_field_id( 'listID' )); ?>"><?php _e( 'List ID (from MailChimp):', 'wdv_mailchimp_ajax_widget' ); ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id('titletextcolor')); ?>"><?php _e('Change the color of the title:', 'wdv_mailchimp_ajax_widget'); ?></label><br> 
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id('descriptiontextcolor')); ?>"><?php _e('Change the color of the description:', 'wdv_mailchimp_ajax_widget'); ?></label><br> 
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id('buttonbgcolor')); ?>"><?php _e('Change the color for the button background:', 'wdv_mailchimp_ajax_widget'); ?></label><br> 
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id('buttontextcolor')); ?>"><?php _e("Change the color for the text on the button:", 'wdv_mailchimp_ajax_widget'); ?></label><br> 
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id('bgcolor')); ?>"><?php _e('Change the color of the widget background:', 'wdv_mailchimp_ajax_widget'); ?></label><br> 
        ...
        <p>
        <label for="<?php echo esc_attr($this->get_field_id( 'padding' )); ?>"><?php _e( 'Create padding around the widget (in pixels):', 'wdv_mailchimp_ajax_widget' ); ?></label>
