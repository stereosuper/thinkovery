        ...
        <div class='footer-top'>
            <div class='container'>
                <div class='container-medium'>
                    ...
                    <a href='<?php the_field('ctaLink', 'options'); ?>' class='btn'><?php the_field('ctaLinkTxt', 'options'); ?><svg class='icon'><use xlink:href='#icon-arrow-right'/></svg></a>
                </div>
            </div>
        </div>
        <div class='container'>
    ...
    <svg style='position:absolute;width:0;height:0;overflow:hidden'>
        <defs>
            <symbol id='icon-hoop' viewBox='0 0 32 32'>
                <title>hoop</title>
                <path d='M16 4.48c6.362 0 11.52 5.158 11.52 11.52s-5.158 11.52-11.52 11.52c-6.362 0-11.52-5.158-11.52-11.52s5.158-11.52 11.52-11.52zM16 0c-8.837 0-16 7.163-16 16s7.163 16 16 16c8.837 0 16-7.163 16-16s-7.163-16-16-16z'></path>
            </symbol>
