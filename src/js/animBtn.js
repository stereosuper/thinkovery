...
module.exports = function(body){
    ...
    body.on('mouseenter', '.btn, #menu-main a, .networks-links a, .share-post a, .related-posts a, .form-search button', function(e){
    ...
    }).on('mousemove', '.btn, #menu-main a, .networks-links a, .share-post a, .related-posts a, .form-search button', function(e){
    ...
    }).on('mouseleave', '.btn, #menu-main a, .networks-links a, .share-post a, .related-posts a, .form-search button', function(){
