...
var burgerHandler = function burgerHandler() {
  ...
  var resetMotionState = function resetMotionState() {
    ...
    if (state.queue) {
      ...
      var event = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createNewEvent"])('updateBorders');
      bordersWrapper.dispatchEvent(event);
    }
  };

  var borderIntro = function borderIntro(_ref) {
    var cb = _ref.cb;
    tl = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]({
      delay: 0.3,
      paused: true
    });
    tl.add(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[2], bordersCat[2]], 1, {
      transformOrigin: '0 50%',
      scaleX: 0,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[3], bordersCat[3]], 1, {
          transformOrigin: '50% 0%',
          scaleY: 0
        }, 0.1);
      }
    }, 0.1), gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[0], bordersCat[0]], 1, {
      transformOrigin: '0% 50%',
      scaleX: 1,
      onComplete: function onComplete() {
        tl.add(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[1], bordersCat[1]], 1, {
          transformOrigin: '50% 0%',
          scaleY: 1
        }, 0.1));
        tl.add(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[2], bordersCat[2]], 1, {
  ...
  var borderLearningExperience = function borderLearningExperience(_ref2) {
    var cb = _ref2.cb;
    tl = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]({
      delay: 0.3,
      paused: true
    });
    tl.add(gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[0], bordersCat[0]], 1, {
      transformOrigin: '100% 50%',
      scaleX: 0,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[1], bordersCat[1]], 1, {
          transformOrigin: '50% 100%',
          scaleY: 0
        }, 0.1);
      }
    }, 0.1), gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[2], bordersCat[2]], 1, {
      transformOrigin: '100% 50%',
      scaleX: 1,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[3], bordersCat[3]], 1, {
          ...
          scaleY: 1,
          onComplete: function onComplete() {
            gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].staggerTo([bordersMouse[0], bordersCat[0]], 1, {
              transformOrigin: '0% 50%',
              scaleX: 0.25,
              onComplete: cb
            }, 0.1);
