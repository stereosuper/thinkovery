...
/* harmony import */ var _plugins_MorphSVGPlugin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../plugins/MorphSVGPlugin */ "./wp-content/themes/think/src/js/plugins/MorphSVGPlugin.js");
...
var minionsHandler = function minionsHandler() {
  ...
  var isSafari = _stereorepo_sac__WEBPACK_IMPORTED_MODULE_0__["superSnif"].isSafari();
  ...
  var headerAnim = function headerAnim() {
    ...
    var tlPlayer = new gsap__WEBPACK_IMPORTED_MODULE_1__["TimelineMax"]();
    ...
    tlPlayer.to(player, 0.3, _objectSpread({
      ...
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power4"].easeIn,
      onComplete: function onComplete() {
        if (video) {
          video.classList.add('player-on', 'on');
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(Object(_utils__WEBPACK_IMPORTED_MODULE_5__["query"])({
            selector: '.iframe',
            ctx: video
          }), {
            opacity: 1,
      ...
      y: videoBottom - 50,
      rotation: 90,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Elastic"].easeOut.config(1.1, 0.9),
      delay: 0.3,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set([minions[0], minions[1], minions[3], minions[4]], {
      opacity: 1
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to([minions[0], minions[1], minions[3], minions[4]], 0.5, _objectSpread({
      scale: 3
    }, tweenOptimizations, {
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power1"].easeIn
    }));
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[0], 1.8, {
      bezier: {
        curviness: 1,
        values: [{
          x: -100,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[1], 1.8, _objectSpread({
      bezier: {
        curviness: 1,
        values: [{
          x: -50,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(minions[2], _objectSpread({
      x: 0,
      y: introBottom + 100,
      scale: 3,
      opacity: 1
    }, tweenOptimizations));
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[3], 1.8, {
      bezier: {
        curviness: 1,
        values: [{
          x: 50,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[4], 1.8, {
      bezier: {
        curviness: 1,
        values: [{
          x: 100,
  ...
  var learningAnim = function learningAnim(ratio) {
    if (!animsState['home-learning-experience'].launched) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[2], 0.7, {
        x: 0,
        y: introBottom + 100,
        rotation: 0,
        ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(2),
        onComplete: function onComplete() {
      ...
      var planePathBezier = planePath ? _plugins_MorphSVGPlugin__WEBPACK_IMPORTED_MODULE_2__["MorphSVGPlugin"].pathDataToBezier(planePath) : '';
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(planePath, 1.5, {
        drawSVG: '100%'
      });
      gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(plane, 1.5, {
        bezier: {
        ...
        onComplete: function onComplete() {
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[0], 1, {
            bezier: {
              curviness: 1,
              values: [{
                x: '+=60',
            ...
            ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(1)
          });
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[1], 1.2, {
            bezier: {
              curviness: 1,
              values: [{
                y: "+=".concat(secondSectionBottom / 2)
            ...
            ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power4"].easeInOut
          });
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[2], 1.4, {
            rotation: 450,
            bezier: {
              curviness: 1,
              values: [{
            ...
            ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(1.1)
          });
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(minions[3], {
            x: 153,
            y: introBottom + 123,
            transformOrigin: '100% 100%'
          });
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[3], 1.2, {
            bezier: {
              curviness: 1,
              values: [{
                x: '+=80',
          ...
          gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[4], 1.5, {
            bezier: {
              curviness: 1,
              values: [{
                x: '+=80',
  ...
  var offersAnim = function offersAnim() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(newDrop, duration, {
      bezier: {
        curviness: 1,
        values: [{
          x: '-=160',
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[1], duration, {
      y: '+=60',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power4"].easeInOut,
      delay: delay * 2
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[2], duration, {
      rotation: 360,
      y: '+=40',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(1.5),
      delay: delay
    });
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minions[3], duration, {
      y: '+=20',
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power1"].easeInOut
    });
  };
  ...
  var aboutAnim = function aboutAnim() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[9], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[9], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[3], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[3], duration, {
          y: fourthSectionBottom,
          rotation: -90,
          ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Sine"].easeIn,
          delay: delayFall
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[0], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[0], duration, {
          y: fourthSectionBottom,
          ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Power1"].easeIn,
          delay: delayFall
        });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[1], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[1], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[7], durationSmall, {
      scale: 1,
      opacity: 1,
      scaleX: -1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[7], duration, {
          y: fourthSectionBottom,
          ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Sine"].easeIn,
          delay: delayFall
        });
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[5], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[5], duration, {
          y: fourthSectionBottom,
          rotation: -90,
          ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Sine"].easeIn,
          delay: delayFall
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[2], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[2], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[8], durationSmall, {
      scale: 1,
      opacity: 1,
      scaleX: -1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[8], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[10], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[10], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[4], durationSmall, {
      scale: 1,
      opacity: 1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[4], duration, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[6], durationSmall, {
      scale: 1,
      opacity: 1,
      scaleX: -1,
      ease: _global__WEBPACK_IMPORTED_MODULE_4__["easing"].easePop,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to(minionsFourthSection[6], duration, {
  ...
  var experiencesAnim = function experiencesAnim() {
    ...
    tl.to(minionsMorpion[1], duration, {
      scale: 1,
      opacity: 1,
      ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(0.5)
      ...
      delay: delay,
      onComplete: function onComplete() {
        gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].to([minionsMorpion[1], minionsMorpion[2], minionsMorpion[3]], duration, {
          rotation: 10,
          scale: 1.1,
          ease: gsap__WEBPACK_IMPORTED_MODULE_1__["Back"].easeInOut.config(0.5),
          delay: delay,
  ...
  var initAnims = function initAnims() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(planePath, {
      drawSVG: 0
    });
  };
  ...
  var resetAnims = function resetAnims() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(minions, {
      opacity: 0,
      scale: 0,
      x: 0,
      y: 0,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__["TweenMax"].set(plane, {
      x: 0,
      y: 0,
      rotation: 0
    });
  ...
  _stereorepo_sac__WEBPACK_IMPORTED_MODULE_0__["superWindow"].addResizeEndFunction(function () {
